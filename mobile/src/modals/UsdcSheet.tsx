  ...
  return (
    <Sheet title="USDC changes the route. Not the FX." onClose={onClose}>
      ...
      <View style={sheetStyles.note}>
        <T weight="bold" size={12} color="#577346" lineHeight={22}>Could it help?</T>
        <T size={12} color="#577346" lineHeight={22} style={{ marginTop: 7 }}>Possibly, if both businesses already use USDC or a supported route reduces the total cost. For this sample, the specialist route is cheaper. A dollar peg does not fix a CAD/EUR rate.</T>
      </View>
